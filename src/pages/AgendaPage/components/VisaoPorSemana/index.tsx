...
import { CORES_DA_PRIORIDADE, TELA_ESTREITA_PARA_A_SEMANA } from "../../../../constants";
...
export default function VisaoPorSemana({
  ...
  return (
    <Grid
      ...
      gap="8px"
      /* Abaixo desta régua a faixa ROLA na horizontal com coluna de 112px,
         em vez de encolher -- a medida e o porquê de não ser o `md` do
         Chakra estão em `TELA_ESTREITA_PARA_A_SEMANA`. */
      css={{
        [`@media ${TELA_ESTREITA_PARA_A_SEMANA}`]: {
