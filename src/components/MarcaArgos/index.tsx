...
const MEDIDAS = {
  barra: { simbolo: "26px", raio: "7px", palavra: "17px", direcao: "row", gap: "9px" },
 ...
 */
export default function MarcaArgos({ tamanho = "barra" }: MarcaArgosProps) {
